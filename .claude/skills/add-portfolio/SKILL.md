---
name: add-portfolio
description: 포트폴리오 카드를 assets/assets/data/portfolio.json에 추가합니다
argument-hint: "[프로젝트명]"
disable-model-invocation: true
allowed-tools: Read, Edit
---

`assets/data/portfolio.json`에 새 포트폴리오 항목을 추가합니다.

## 진행 순서

1. `assets/data/portfolio.json` 파일을 읽어 현재 항목 수와 마지막 번호 확인
...
- 추가 후 `assets/data/portfolio.json` 전체 내용을 보여주며 확인 요청
